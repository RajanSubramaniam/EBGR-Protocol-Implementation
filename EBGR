EBGR-Protocol-Implementation-in-C-
==================================

EBGR - Edge Node Based Greedy Routing Algorithm is used to find the optimum node within a particular range in Vehicular Ad-hoc Network Scenario


Vanet Structure for 14 nodes within Trnamission range 600m
...
int main()
{
    ...
    float position1[14]={530,490,598,530,702,670,653,310,811,802,990,785,897,1090};
    float position2[14]={570,510,630,560,750,701,701,375,880,880,1010,812,920,1115};
    float time=20;
    
    float v[14]={};
    for (int i=0; i<14; i++)
    {
        v[i]=(position2[i]-position1[i])/time;
        cout<<"V["<<i<<"]: "<<v[i]<<endl;
    }
    ...
    float dm1;
    dm1=ed1.direction_motion(le1,v[1],v[13]);
    cout<<"direction of motion== "<<dm1<<endl;
    float rls1;
    rls1=ed1.link_stability(a[1][1],a[1][2],a[2][1],a[2][2],v[0],v[1]);
    ...
    float dm2;
    dm2=ed2.direction_motion(le2,v[2],v[13]);
    cout<<"direction of motion== "<<dm2<<endl;
    float rls2;
    rls2=ed2.link_stability(a[1][1],a[1][2],a[3][1],a[3][2],v[0],v[2]);
    ...
    float dm3;
    dm3=ed3.direction_motion(le3,v[3],v[13]);
    cout<<"direction of motion== "<<dm3<<endl;
    float rls3;
    rls3=ed3.link_stability(a[1][1],a[1][2],a[4][1],a[4][2],v[0],v[3]);
    ...
    cout<<"N5:"<<endl;
    float dc4;
    dc4=ed4.distance_calculation(a[3][1],a[3][2],a[5][1],a[5][2],a[14][1],a[14][2]);
    cout<<"DC== "<<dc4<<endl;
    float le4;
    le4=ed4.length(a[5][1],a[5][2],a[14][1],a[14][2]);
    float dm4;
    dm4=ed4.direction_motion(le4,v[4],v[13]);
    cout<<"direction of motion== "<<dm4<<endl;
    float rls4;
    rls4=ed4.link_stability(a[3][1],a[3][2],a[5][1],a[5][2],v[2],v[4]);
    ...
    cout<<"N6:"<<endl;
    float dc5;
    dc5=ed5.distance_calculation(a[3][1],a[3][2],a[6][1],a[6][2],a[14][1],a[14][2]);
    cout<<"DC== "<<dc5<<endl;
    float le5;
    le5=ed5.length(a[6][1],a[6][2],a[14][1],a[14][2]);
    float dm5;
    dm5=ed5.direction_motion(le5,v[5],v[13]);
    cout<<"direction of motion== "<<dm5<<endl;
    float rls5;
    rls5=ed5.link_stability(a[3][1],a[3][2],a[6][1],a[6][2],v[2],v[5]);
    ...
    float dm6;
    dm6=ed6.direction_motion(le6,v[7],v[13]);
    cout<<"direction of motion== "<<dm6<<endl;
    float rls6;
    rls6=ed6.link_stability(a[6][1],a[6][2],a[8][1],a[8][2],v[5],v[7]);
    ...
    float dm7;
    dm7=ed7.direction_motion(le7,v[9],v[13]);
    cout<<"direction of motion== "<<dm7<<endl;
    float rls7;
    rls7=ed7.link_stability(a[6][1],a[6][2],a[10][1],a[10][2],v[5],v[9]);
    ...
    if(ps6>ps7)
    {
        ...
        cout<<endl;
        cout<<"Transmission Route :"<<endl;
        cout<<"N1--N3--N6--N8"<<endl;
    }
    else
    {
        cout<<"Edge Node:N10"<<endl;
        cout<<"Transmission Route :"<<endl;
        cout<<"N1--N3--N6--N10"<<endl;    }
    ...
    float dm8;
    dm8=ed8.direction_motion(le8,v[6],v[13]);
    cout<<"direction of motion== "<<dm8<<endl;
    float rls8;
    rls8=ed8.link_stability(a[8][1],a[8][2],a[7][1],a[7][2],v[7],v[6]);
    ...
    float dm9;
    dm9=ed9.direction_motion(le9,v[8],v[13]);
    cout<<"direction of motion== "<<dm9<<endl;
    float rls9;
    rls9=ed9.link_stability(a[8][1],a[8][2],a[9][1],a[9][2],v[7],v[8]);
    ...
    float dm10;
    dm10=ed10.direction_motion(le10,v[11],v[13]);
    cout<<"direction of motion== "<<dm10<<endl;
    float rls10;
    rls10=ed10.link_stability(a[8][1],a[8][2],a[12][1],a[12][2],v[7],v[11]);
    ...
    if (ps8>ps9 && ps8>ps10)
    {
        ...
        cout<<"Transmission Route: "<<endl;
        cout<<"N1--N3--N6--N8--N7"<<endl;
    }
    else if (ps9>ps10 && ps9>ps8)
    {
        cout<<"Edge Node:N9"<<endl;
        cout<<"Transmission Route: "<<endl;
        cout<<"N1--N3--N6--N8--N9"<<endl;
    }
    else
    {
        cout<<"Edge Node:N12"<<endl;
        cout<<"Transmission Route: "<<endl;
        cout<<"N1--N3--N6--N8--N12"<<endl;
    }
    ...
    float dm11;
    dm11=ed11.direction_motion(le11,v[10],v[13]);
    cout<<"direction of motion== "<<dm11<<endl;
    float rls11;
    rls11=ed11.link_stability(a[7][1],a[7][2],a[11][1],a[11][2],v[6],v[10]);
    ...
    cout<<endl;
    cout<<"Transmission Route :"<<endl;
    cout<<"N1--N3--N6--N8--N7--N11"<<endl;
    cout<<endl;
    cout<<"Nodes in between 500 and 600 meters : "<<endl;
    cout<<"N13,N14"<<endl;
    cout<<endl;
    cout<<"Transmission Route :"<<endl;
    cout<<"N1--N3--N6--N8--N7--N11--N14"<<endl;
    cout<<endl;
